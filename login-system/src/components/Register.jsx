        ...
        <div className="col-span-6 col-start-4 p-5">
          ...
          <form onSubmit={handleSignUp}>
            <input
              ...
              className={SignupStyle.signupInput}
            ...
            <button
              className="px-4 py-2 font-semibold text-lg bg-blue-600 rounded w-[45%] mx-2 hover:bg-blue-400"
              type="submit"
            >
              Signup
            </button>
            ...
            <button
              type="button"
              onClick={resetForm}
              className="px-4 py-2 font-semibold text-lg bg-red-600 rounded w-[45%] mx-2 hover:bg-red-400"
            >
              Clear
            </button>
          </form>
